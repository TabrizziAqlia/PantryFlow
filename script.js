...
let pantryItems = JSON.parse(local Storage.getItem('pantryItems')) ||
...
// FIX: Mengambil nilai dari input 'date' (berdasarkan ID 'exp-date')
const date = document.getElementById('exp-date').value; 
const qty = parseInt(document.getElementById('quantity').value);    
// FIX: Ada 2 select dengan ID 'item-category'. Sebaiknya ganti salah satu ID di HTML/ambil yang pertama.
